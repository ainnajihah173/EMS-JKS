                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="applicant[app_age]" type="number"
                                                        id="age" value="{{ $data->applicant->app_age ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="example-text-input" class="form-control-label">
                                                        No. Kad Pengenalan <span class="text-danger">*</span></label>
                                                    <input class="form-control" name="spouse[app_ic]" id="ic_number"
                                                        type="text" value="{{ $data->spouse->app_ic ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="spouse[app_age]" type="number"
                                                        id="age" value="{{ $data->spouse->app_age ?? '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" name="spouse[app_nationality]">
                                                        <option value="0">Sila Pilih...</option>
                                                        <option value="1"
                                                            {{ ($data && $data->spouse->app_nationality) == '1' ? 'selected' : '' }}>
                                                            Warganegara</option>
                                                        <option value="2"
                                                            {{ ($data && $data->spouse->app_nationality) == '2' ? 'selected' : '' }}>
                                                            Bukan Warganegara</option>
                                                    </select>
...
@push('js')
    <script>
        ...
        // Create the formatted date string (e.g., YYYY-MM-DD)
